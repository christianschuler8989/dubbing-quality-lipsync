...
# Read data
data_prep <- read_csv(file = "data_cooked_prep.csv")
data_rare <- read_csv(file = "data_cooked_rare.csv")
data_medium_rare <- read_csv(file = "data_cooked_medium_rare.csv")
data_medium <- read_csv(file = "data_cooked_medium.csv")
...
setwd("~/thesis_october/evaluating/r_project_thesis/")
# Meta data ####################################################################
################################################################################
